...
class TranslationApp: 
    def __init__(self,root):
        ...
        backgound_image = Image.open(r"./wooden-stairs-pink-2560x1080-15788.jpg") 
        self.backgound_photo = ImageTk.PhotoImage(backgound_image)
        backgound_label = tk.Label(root, image= self.backgound_photo)
        ...
        self.src_lang_combo = ttk.Combobox(lang_frame, values=["English", "French", "Spanish", "German"])
        ...
        self.dest_lang_combo = ttk.Combobox(lang_frame, values=["English", "French", "Spanish", "German"])
    ...
    def translate_text(self):
        ...
        translated = translator.translate(
            ...
            dest=self.dest_lang_combo.get().lower()
        )
        self.translated_text.delete(1.0, tk.END)
        self.translated_text.insert(tk.END, translated.text)

    def pronounce_text(self):
        text_to_pronounce = self.translated_text.get(1.0, tk.END)
        tts = gTTS(text=text_to_pronounce, lang=self.dest_lang_combo.get().lower())
...
def main():
    ...
    root.geometry("1000x900")  # Set initial window size
    root.mainloop()
